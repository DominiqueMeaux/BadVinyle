...
class ProviderController extends AbstractController
{
    ...
    /**
     * @Route("/{prov_siren}", name="provider_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{prov_siren}/edit", name="provider_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{prov_siren}", name="provider_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Provider $provider): Response
    {
        if ($this->isCsrfTokenValid('delete'.$provider->getProv_siren(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
